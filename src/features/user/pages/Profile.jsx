  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#edf2ff] font-sans pb-24 overflow-x-hidden selection:bg-[#E85D04] selection:text-white">
      ...
      <section className="relative w-full mb-28 md:mb-40 pt-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-[150px] md:pt-[250px]">
      ...
      <AnimatePresence>
        {isEditing && (
          <motion.section initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="max-w-7xl mx-auto px-4 mb-16 overflow-hidden">
      ...
      {/* ── MAIN LAYOUT (70 / 30) ── */}
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-10 pb-20">
