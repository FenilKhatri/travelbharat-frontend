  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-2">States Directory</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Create, edit and manage Indian states registered for TravelBharat explorer guides.</p>
        </div>
